    ...
    >
      ...
      <ol>
        ...
        <li>
          ...
          необходимую информацию в течение 10 рабочих дней с даты получения
          такого запроса. Срок может быть продлён, но не более чем на пять
          рабочих дней, с направлением мотивированного уведомления;
        </li>
        <li>
          в порядке, определённом федеральным органом исполнительной власти,
      ...
      <p>
        ...
        получения запроса. Срок может быть продлён, но не более чем на пять
        рабочих дней.
      </p>
      ...
      <ul>
        <li>
          ...
          предполагаемых причинах и принятых мерах;
        </li>
        <li>
