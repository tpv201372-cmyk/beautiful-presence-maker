...
const faqs = [
  ...
  },
  {
    ...
    a: "Нет. Все переговоры мы ведём по готовым шаблонам и через переводчик. На курсе я даю проверенные скрипты на китайском языке, которыми пользуюсь сама.",
  },
  {
  ...
  },
  {
    ...
    a: "Вы получите алгоритм, по которому уже работают другие байеры, и сможете найти то, что подойдет именно вам.",
  },
  {
