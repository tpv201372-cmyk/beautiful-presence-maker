...
const faqs = [
  ...
  },
  {
    ...
    a: "Нет. Все переговоры мы ведём по готовым шаблонам и через переводчик. На курсе я даю проверенные скрипты на английском и китайском, которыми пользуюсь сама.",
  },
  {
