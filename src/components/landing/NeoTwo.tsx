...
const features = [
  ...
  },
  {
    ...
    text: "Как не попасть на деньги при заказе габаритных товаров, грамотно просчитать стоимость и подобрать упаковку. Даю проверенный сервис доставки от 300 г — возят чай и часы.",
  },
  {
    icon: Coins,
