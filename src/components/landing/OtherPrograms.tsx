...
const clubModules: Module[] = [
  {
    ...
    topics: [
      ...
      "Подготовка: как скачать Алипей, 1688, Таобао, Пиндуодуо и Пойзон на Айфон и Андроид",
...
const neoModules: Module[] = [
  ...
  {
    title: "Приложения: VIPSHOP, Weidian, GoFish и WeChat (Вичат)",
    topics: [
      ...
      "Регистрация и использование приложения WeChat (Вичат)",
